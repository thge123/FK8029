...
def main():
    ...
    ax.plot([0,100],[4.e17,4e17],lw=1,ls='--',c='k',label='$T_{1/2}=4\cdot 10^{17}$ s')
    ...
    ax.scatter([1e20],[1e20],marker=Markers[2],edgecolor=Colors[2],facecolor='none',label='$R_0=1.15$ fm')
